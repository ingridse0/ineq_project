# -----------------------------------------------------------------------------
#
# SET UP for material depreviation
# Group DNK
# 2004 - 2017
#
# -----------------------------------------------------------------------------
...
silc.pov <- silc.prh %>% drop_na(hs011, hs110, hh050, hs040, hs050, hs060, hs070, hs080, hs100)

# Check columns
hs011a <-
hs080a <- silc.pov$hs080 >=2
...
silc.pov2 <-  bind_cols(hs080 = hs080a, hs070 = hs080a)
