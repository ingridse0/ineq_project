# This script generates the tables

# 80/20 quantile share ratio

frame_8020 <- data.frame(i11_8020[2], i12_8020[2], i13_8020[2],
...
frame_arpr <- data.frame(i11_arpr[2], i12_arpr[2], i13_arpr[2],
...
frame_mean <- data.frame(i11_mean[2], i12_mean[2], i13_mean[2],
...
frame_t10s <- data.frame(i11_t10s[2], i12_t10s[2], i13_t10s[2],
